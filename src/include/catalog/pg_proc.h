...
DATA(insert OID = 3300 (  pg_notify				PGNSP PGUID 12 1 0 0 0 f f f f f f v 3 0 2278 "25 25 16" _null_ _null_ _null_ _null_ _null_ pg_notify _null_ _null_ _null_ ));
DESCR("send a notification event");
